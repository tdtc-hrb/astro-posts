...
---
This article adds menu events and shortcut key responses in CFrameWnd(CMainWindow). 
The modifications are based on the [HelloMFC example](../hello3-mfc).

### CMainWindow - CFrameWnd
add feature in the constructor:
- load menu
```
